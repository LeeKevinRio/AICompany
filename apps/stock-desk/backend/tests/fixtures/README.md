...
| `tpex_trading_stock_6147_202609.json` | 同上端點，2026-09-19 頎邦（6147）資料不足事故的樣本標的與月份 | 表頭依 CEO 本機 2026-09-19 真實回應抄錄（`日 期` 含空白、成交量欄為 `成交張數`）；資料列為合成值；測「表頭去空白」與「張 → ×1000」轉換分支 |
